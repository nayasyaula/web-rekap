                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        <li class="nav-item">
                            <a href="#" class="nav-link align-middle px-0">
                                <a href="/pembimbing/dashboard" class="nav-link px-0"><span class="ms-1 d-none d-sm-inline"><i class="fi fi-rr-apps"></i> Dashboard</span></a>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('pembimbing.student.index') }}" class="nav-link px-0 align-middle">
                            <span class="ms-1 d-none d-sm-inline"><i class="fi fi-rr-square-poll-vertical"></i> Data Siswa</span></a>
                        </li>
                        <li>
                            <a href="{{ route('pembimbing.late.index') }}" class="nav-link px-0 align-middle">

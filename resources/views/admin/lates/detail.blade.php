...
@section('content')
    ...
    <div class="table shadow p-1 mb-4 border-0" style="background-color: white;">
        <ul class="nav nav-tabs">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.late.home') }}">Keseluruhan Data</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="{{ route('admin.late.rekap')}}">Rekapitulasi Data</a>
            </li>
          </ul>
          <br>
        <table class="table"> 
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('admin.late.show', ['student_id' => $lates->id]) }}">lihat</a></td>
                    <td>
                        <a class="btn btn-primary" href="{{ route('admin.late.print',  $lates['id']) }}">Cetak surat pernyataan</a>
                    </td>
                </tr>
                @endforeach
            </tbody>

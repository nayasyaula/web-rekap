...
<div class="jumbroton py-2 px-1">
    ...
    <p style="color: black;">
        ...
        <a class="button_waterpump" style="color: black;">Edit Data Rayon</a>
    </p>
</div>
@if (Session::get('success'))
        ...
        @endif
    <form action="{{ route('admin.rayon.update', $rayon['id']) }}" method="POST" class="card p-5 shadow p-1 mb-4 border-0" style="width: 80%">
        @csrf
        @method('PATCH')
        <div class="mb-3 row">
